...
import { Send, Mic, Volume2, VolumeX, Check, X, Loader2, Calendar, ListTodo, WifiOff, Phone } from "lucide-react";
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-3">
        <AiDisclosureBanner className="mb-3" context="緊急のご用件は直接お電話等でご連絡ください。" />
